    ...
    BEGIN
        ...
        ELSE
            BEGIN
                ...
                WHERE
                        template_name = p_template_name and template_description = p_template_description;                 
            EXCEPTION
                WHEN no_data_found THEN
                    NULL;
            END;
            IF l_temp_cnt > 0 THEN
                p_return_status := ' Template Name or Template Description already exists Please Create unique Template Name and Template Description';
            ELSE
        ...
        END;
            ...
            IF l_templn_cnt > 0 THEN
                p_return_status := ' Sequence '
                                   || p_sequence
                                   || ' already exists Please Create unique Sequence';
            ELSE
    ...
    BEGIN
        ...
        ELSE
            BEGIN
                ...
                WHERE
                        organization_number = p_organization_number and account_number = p_account_number;                 
            EXCEPTION
                WHEN no_data_found THEN
                    NULL;
            END;

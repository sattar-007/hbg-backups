...
/
CREATE OR REPLACE EDITIONABLE TYPE BODY "HBG_INTEGRATION"."HBG_AR_CUSTMAINTAIN_TRX_RT" AS
    CONSTRUCTOR FUNCTION "HBG_AR_CUSTMAINTAIN_TRX_RT"   RETURN SELF AS RESULT AS
    BEGIN
        RETURN;
    END;
END;

--------------------------------------------------------
--  DDL for Table HBG_CX_ITEMS_EXTRACT_BKP
--------------------------------------------------------

  CREATE TABLE "HBG_INTEGRATION"."HBG_CX_ITEMS_EXTRACT_BKP" 
 ...
 LOB ("BOOK_DESCRIPTION") STORE AS SECUREFILE (
  ...
  PCTINCREASE 0
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
  GRANT SELECT ON "HBG_INTEGRATION"."HBG_CX_ITEMS_EXTRACT_BKP" TO "RO_HBG_INTEGRATION";

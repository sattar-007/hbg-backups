...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "HBG_INTEGRATION"."AS_SFTP" 
is
  --
...
--
  ...
  begin
    ...
    g_con := utl_tcp.open_connection( remote_host => p_host, remote_port => p_port, in_buffer_size => 32767, tx_timeout => 240 );
    loop

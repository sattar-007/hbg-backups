...
--------------------------------------------------------
  ...
  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "HBG_INTEGRATION"."HBG_PRE_RESERVATIONS_PKG" AS
    ...
    PROCEDURE hbg_pre_res_header_create (
        p_pre_reservation_number    IN NUMBER,
    ...
    BEGIN
        ...
        ELSIF l_check_count > 0 THEN
            ...
            ELSIF l_subinventory <> p_subinventory THEN
                INSERT INTO xxhbg_res_pre_reservation_history (
                    pre_reservation_number,
                    item_code,
                    criteria_uid,
                ...
                COMMIT;
            ELSIF l_lot_number <> p_lot_number THEN
                INSERT INTO xxhbg_res_pre_reservation_history (
                    pre_reservation_number,
                    item_code,
                    criteria_uid,
                ...
                COMMIT;
            ELSIF l_requested_quantity <> p_requested_quantity THEN
                INSERT INTO xxhbg_res_pre_reservation_history (
                    pre_reservation_number,
                    item_code,
                    criteria_uid,

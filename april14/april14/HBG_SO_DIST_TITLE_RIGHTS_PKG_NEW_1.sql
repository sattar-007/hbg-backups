--------------------------------------------------------
--  DDL for Package Body HBG_SO_DIST_TITLE_RIGHTS_PKG_NEW
--------------------------------------------------------

  CREATE OR REPLACE EDITIONABLE PACKAGE BODY "HBG_INTEGRATION"."HBG_SO_DIST_TITLE_RIGHTS_PKG_NEW" IS
            ...
            FOR c_missing_rights_val_rec IN c_title_rights_val LOOP
                IF ( c_missing_rights_val_rec.one_time_final_address IS NOT NULL ) THEN
                    ...
                    BEGIN
                        ...
                        WHERE
                                1 = 1
                            AND htre.inventory_item_id = c_missing_rights_val_rec.inventory_item_id
                            AND NOT EXISTS (
                                SELECT
                                    1
                                FROM
...
END hbg_so_dist_title_rights_pkg_new;

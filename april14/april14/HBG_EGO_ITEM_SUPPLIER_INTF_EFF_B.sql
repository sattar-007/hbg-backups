--------------------------------------------------------
--  DDL for Table HBG_EGO_ITEM_SUPPLIER_INTF_EFF_B
--------------------------------------------------------

  CREATE TABLE "HBG_INTEGRATION"."HBG_EGO_ITEM_SUPPLIER_INTF_EFF_B" 
   (	"TRANSACTION_TYPE" VARCHAR2(10 BYTE), 
	...
	"VERSION_START_DATE" TIMESTAMP (6), 
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT SELECT ON "HBG_INTEGRATION"."HBG_EGO_ITEM_SUPPLIER_INTF_EFF_B" TO "RO_HBG_INTEGRATION";

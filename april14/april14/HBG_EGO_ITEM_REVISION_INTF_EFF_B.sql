--------------------------------------------------------
--  DDL for Table HBG_EGO_ITEM_REVISION_INTF_EFF_B
--------------------------------------------------------

  CREATE TABLE "HBG_INTEGRATION"."HBG_EGO_ITEM_REVISION_INTF_EFF_B" 
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT SELECT ON "HBG_INTEGRATION"."HBG_EGO_ITEM_REVISION_INTF_EFF_B" TO "RO_HBG_INTEGRATION";

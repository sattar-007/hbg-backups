--------------------------------------------------------
--  DDL for Table DOO_LINE_STATUSES
--------------------------------------------------------

  CREATE TABLE "HBG_INTEGRATION"."DOO_LINE_STATUSES" 
   (	"LINE_STATUS_ID" NUMBER, 
	"STATUS_CODE" VARCHAR2(120 BYTE), 
	"DEFAULT_FLAG" VARCHAR2(4 BYTE), 
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT SELECT ON "HBG_INTEGRATION"."DOO_LINE_STATUSES" TO "RO_HBG_INTEGRATION";

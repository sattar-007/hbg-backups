...
--    END;
    ...
    PROCEDURE search_transactions (
        ...
        WHERE
            ...
            AND trx_class IN ( decode(v_include_inv, 'Y', 'INV', 'INV2'), decode(v_include_cm, 'Y', 'CM', 'CM2'),decode(v_include_cm, 'Y', 'ONACC', 'ONACC2'), decode(v_include_inv
        ...
        SELECT
            ...
            NULL                                               invoice_number,
            arps.amount_due_remaining                     amount,
            to_char(arps.due_date, 'YYYY-MM-DD')              due_date,

--------------------------------------------------------
--  DDL for Table FND_FLEX_VALUES_VL
--------------------------------------------------------

  CREATE TABLE "HBG_INTEGRATION"."FND_FLEX_VALUES_VL" 
   (	"ROW_ID" ROWID, 
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT SELECT ON "HBG_INTEGRATION"."FND_FLEX_VALUES_VL" TO "RO_HBG_INTEGRATION";

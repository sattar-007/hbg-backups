--------------------------------------------------------
--  DDL for Table HBG_EGP_SYSTEM_ITEMS_INTERFACE3
--------------------------------------------------------

  CREATE TABLE "HBG_INTEGRATION"."HBG_EGP_SYSTEM_ITEMS_INTERFACE3" 
 ...
 LOB ("HTML_LONG_DESCRIPTION") STORE AS SECUREFILE (
  ...
  PCTINCREASE 0
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
  GRANT SELECT ON "HBG_INTEGRATION"."HBG_EGP_SYSTEM_ITEMS_INTERFACE3" TO "RO_HBG_INTEGRATION";

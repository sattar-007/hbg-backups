--------------------------------------------------------
--  DDL for Table DOO_FULFILL_LINES_EFF_B
--------------------------------------------------------

  CREATE TABLE "HBG_INTEGRATION"."DOO_FULFILL_LINES_EFF_B" 
   (	"EFF_LINE_ID" NUMBER, 
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT SELECT ON "HBG_INTEGRATION"."DOO_FULFILL_LINES_EFF_B" TO "RO_HBG_INTEGRATION";

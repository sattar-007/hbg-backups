--------------------------------------------------------
--  DDL for Table HBG_CX_ITEMS_BISAC_EXTRACT
--------------------------------------------------------

  CREATE TABLE "HBG_INTEGRATION"."HBG_CX_ITEMS_BISAC_EXTRACT" 
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT SELECT ON "HBG_INTEGRATION"."HBG_CX_ITEMS_BISAC_EXTRACT" TO "RO_HBG_INTEGRATION";

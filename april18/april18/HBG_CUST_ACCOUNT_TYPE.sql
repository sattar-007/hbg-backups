...
--------------------------------------------------------
  ...
  CREATE TABLE "HBG_INTEGRATION"."HBG_CUST_ACCOUNT_TYPE" 
   (	"ACC_TYP_ID" NUMBER DEFAULT "HBG_INTEGRATION"."ACC_TYP_ID_SEQ"."NEXTVAL", 
	...
	"SITE_PURPOSE" VARCHAR2(200 BYTE), 
	"ADDRESS1" VARCHAR2(200 BYTE), 
	"ADDRESS2" VARCHAR2(200 BYTE), 
	"ADDRESS3" VARCHAR2(200 BYTE), 
	"ADDRESS4" VARCHAR2(200 BYTE), 
	"BILL_TO_SAN" VARCHAR2(200 BYTE), 
	"SHIP_TO_SAN" VARCHAR2(200 BYTE), 
	"ACCOUNT_LOOKUP1" VARCHAR2(200 BYTE), 
	"ACCOUNT_LOOKUP2" VARCHAR2(200 BYTE), 
	"ACCOUNT_LOOKUP3" VARCHAR2(200 BYTE)

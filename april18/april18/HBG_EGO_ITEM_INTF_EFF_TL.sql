--------------------------------------------------------
--  DDL for Table HBG_EGO_ITEM_INTF_EFF_TL
--------------------------------------------------------

  CREATE TABLE "HBG_INTEGRATION"."HBG_EGO_ITEM_INTF_EFF_TL" 
 ...
 NOCOMPRESS LOGGING
  ...
  GRANT SELECT ON "HBG_INTEGRATION"."HBG_EGO_ITEM_INTF_EFF_TL" TO "RO_HBG_INTEGRATION";
